...
CREATE TABLE IF NOT EXISTS etf_list (
    ...
    etf_industry VARCHAR(50) COMMENT 'ETF所属行业',
...
CREATE TABLE IF NOT EXISTS sector_data (
    ...
    riser_count INT COMMENT '上涨家数',
    faller_count INT COMMENT '下跌家数',
    leader_stock_code VARCHAR(10) COMMENT '领涨股票代码',
    leader_stock_name VARCHAR(50) COMMENT '领涨股票名称',
    leader_stock_change_pct DECIMAL(10, 4) COMMENT '领涨股票涨跌幅(%)',
    PRIMARY KEY (id, trade_date),
